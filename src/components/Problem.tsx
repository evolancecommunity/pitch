    ...
    <section className="py-24 bg-gradient-to-br from-slate-900 via-purple-900 to-slate-800 relative overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto px-4 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
          <div className="bg-white rounded-2xl p-8 shadow-2xl border-2 border-red-200 hover:bg-red-50 transition-all duration-300">
            <div className="flex items-center mb-6">
              ...
              <h3 className="text-xl font-bold text-slate-900">Emotional Invisibility</h3>
            </div>
            ...
            <div className="bg-red-50 rounded-lg p-4 border border-red-100">
              <p className="text-sm text-red-900 italic font-semibold">
                "I feel overwhelmed but I can't explain why. Nothing understands me."
              </p>
            </div>
          </div>

          <div className="bg-white rounded-2xl p-8 shadow-2xl border-2 border-orange-200 hover:bg-orange-50 transition-all duration-300">
            <div className="flex items-center mb-6">
              ...
              <h3 className="text-xl font-bold text-slate-900">Digital Burnout</h3>
            </div>
            <p className="text-slate-700 mb-4 text-sm leading-relaxed font-medium">
            ...
            <div className="bg-orange-50 rounded-lg p-4 border border-orange-100">
              <p className="text-sm text-orange-900 italic font-semibold">
          ...
          <div className="bg-white rounded-2xl p-8 shadow-2xl border-2 border-purple-200 hover:bg-purple-50 transition-all duration-300">
            <div className="flex items-center mb-6">
              ...
              <h3 className="text-xl font-bold text-slate-900">Surface-Level Tools</h3>
            </div>
            <p className="text-slate-700 mb-4 text-sm leading-relaxed font-medium">
              Mental health apps track mood or provide CBT tips but don't build long-term emotional identity.
            </p>
            <div className="bg-purple-50 rounded-lg p-4 border border-purple-100">
              <p className="text-sm text-purple-900 italic font-semibold">
          ...
          <div className="bg-white rounded-2xl p-8 shadow-2xl border-2 border-blue-200 hover:bg-blue-50 transition-all duration-300">
            <div className="flex items-center mb-6">
              ...
              <h3 className="text-xl font-bold text-slate-900">Disconnected Generation</h3>
            </div>
            <p className="text-slate-700 mb-4 text-sm leading-relaxed font-medium">
            ...
            <div className="bg-blue-50 rounded-lg p-4 border border-blue-100">
              <p className="text-sm text-blue-900 italic font-semibold">
